...
pdf.ln()
pdf.multi_cell(w=0, h=6, txt=texto1, align='J')
pdf.ln()
pdf.image(name='grafico_bi.png', x=25, y=70, w=150)
pdf.ln(95)
pdf.multi_cell(w=0, h=6, txt=texto2, align='J')
pdf.ln()
pdf.image(name='atencao_cd19.png', x=25, y=220, w=150)
pdf.ln(100)
